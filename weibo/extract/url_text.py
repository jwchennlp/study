...
def updateweibo(add):
    ...
    update=client.post.statuses__update(status=add,lat=40.1232,long=113.12322)
...
def add_timeline(add):
    ...
    for i in range(0,10):
        nearby=client.get.place__nearby_timeline(lat=latitude,long=longitude,count=50,range=2000,starttime=yestime,endtime=nowtime,page=i+1)

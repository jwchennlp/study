...
# weibo api访问配置
APP_KEY = '1836635196'      # app key
APP_SECRET = '04179f03ce391bbc8c441c9be01ed4fb'   # app secret
...
if __name__=="__main__":
    apply_access_token()
    status=client.get.location__geo__geo_to_address(coordinate="116.39794,39.90817")
    print status.geos.province

...
def add_timeline(add):
    ...
    nearby=client.get.place__nearby_timeline(lat=latitude,long=longitude,count=10,range=2000,starttime=yestime,endtime=nowtime,page=1)
...
if __name__ == "__main__":
    ...
    for i in range(0,len(apiinfo)):
        apply_access_token(apiinfo[i+1])
